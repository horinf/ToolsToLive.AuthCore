...
namespace ToolsToLive.AuthCore
{
    public class IdentityService : IIdentityService
    {
        ...
        public Task<IAuthToken> GenerateToken(IUser user, string sessionId)
        {
            ...
            {
                throw new Exception("Token lifetime is not set. Please set at least a few seconds if you use ServerToServer auth, or at least a few minutes if you use client authentication");
            }
